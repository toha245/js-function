...
// function parameters (num1, num2, num3, num4){
...
// splice() syntex 
// let numbers = [2, 3, 5, 8, 9 ,10];
// numbers.splice(1,2,15,30);
// console.log(numbers);
...
// const arrayNumbers = [2, 5, 6, 8, 10];
// const result = make_avg(arrayNumbers, arrayNumbers.length);
// console.log(result);
